...
parser = add_option(parser, '--allowRefAltSwap', action='store_true', default=FALSE, help="Allowing swapping of reference and alternative allele in target vs REF vcf")
